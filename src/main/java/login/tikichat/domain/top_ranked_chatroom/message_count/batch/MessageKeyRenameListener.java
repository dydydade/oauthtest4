...
public class MessageKeyRenameListener implements JobExecutionListener {
    ...
    private static final String TOTAL_KEY_PREFIX = "rank:total:message:chatroom";
    private static final String CATEGORY_KEY_PREFIX = "rank:category:%s:message:chatroom";
