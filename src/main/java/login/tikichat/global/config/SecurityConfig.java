...
import login.tikichat.global.auth.jwt.filter.JwtAuthenticationProcessingFilter;
import login.tikichat.global.auth.jwt.service.JwtService;
import login.tikichat.global.auth.jwt.util.JwtUtils;
import login.tikichat.global.auth.login.filter.CustomJsonUsernamePasswordAuthenticationFilter;
import login.tikichat.global.auth.login.handler.LoginFailureHandler;
...
public class SecurityConfig {
    ...
    public JwtAuthenticationProcessingFilter jwtAuthenticationProcessingFilter() {
        return new JwtAuthenticationProcessingFilter(jwtService, jwtUtils, userRepository, userRefreshTokenService);
    }
